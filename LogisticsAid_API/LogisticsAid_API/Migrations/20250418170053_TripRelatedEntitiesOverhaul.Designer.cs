...
namespace LogisticsAid_API.Migrations
{
    ...
    [Migration("20250418170053_TripRelatedEntitiesOverhaul")]
    partial class TripRelatedEntitiesOverhaul
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.ContactInfo", b =>
                {
                    ...
                    b.ToTable("contact_info", "public", t =>
                        {
                            t.HasCheckConstraint("CK_ContactInfo_SingleCompany", "customer_company_id IS NULL OR carrier_company_id IS NULL");
                        });
                });
