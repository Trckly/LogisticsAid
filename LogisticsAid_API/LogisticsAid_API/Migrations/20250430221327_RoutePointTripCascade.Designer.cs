...
namespace LogisticsAid_API.Migrations
{
    ...
    [Migration("20250430221327_RoutePointTripCascade")]
    partial class RoutePointTripCascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.Trip", b =>
                {
                    ...
                    b.ToTable("trips", "public", t =>
                        {
                            t.HasCheckConstraint("CK_Trip_DateValidation", "\"loading_date\" <= \"unloading_date\"");
                        });
                });
