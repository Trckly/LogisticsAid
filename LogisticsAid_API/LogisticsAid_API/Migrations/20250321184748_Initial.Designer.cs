...
namespace LogisticsAid_API.Migrations
{
    ...
    [Migration("20250321184748_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.Carrier", b =>
                {
                    b.HasOne("LogisticsAid_API.Entities.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.Order", b =>
                {
                    b.HasOne("LogisticsAid_API.Entities.Carrier", "Carrier")
                        .WithOne()
                        .HasForeignKey("LogisticsAid_API.Entities.Order", "CarrierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogisticsAid_API.Entities.Customer", "Customer")
                        .WithOne()
                        .HasForeignKey("LogisticsAid_API.Entities.Order", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogisticsAid_API.Entities.Driver", "Driver")
                        .WithOne()
                        .HasForeignKey("LogisticsAid_API.Entities.Order", "DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogisticsAid_API.Entities.Logistician", "Logistician")
                        .WithOne()
                        .HasForeignKey("LogisticsAid_API.Entities.Order", "LogisticianId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogisticsAid_API.Entities.Transport", "Transport")
                        .WithOne()
                        .HasForeignKey("LogisticsAid_API.Entities.Order", "TransportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogisticsAid_API.Entities.RoutePoint", b =>
                {
                    ...
                    b.HasOne("LogisticsAid_API.Entities.Order", "Order")
